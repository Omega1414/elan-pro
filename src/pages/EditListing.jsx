...
export default function EditListing() {
    ...
    const {type, name, bedrooms, bathrooms, parking, furnished, address, description, regularPrice, discountedPrice, images} = formData
    ...
    useEffect(() => {
        ...
        {
            toast.error("Bu elani deyismek haqqiniz yoxdur")
            navigate("/")
    }
  ...
  return (
    <main className='max-w-md px-2 mx-auto '>
        <h1 className='text-3xl text-center pt-6 font-bold '>Düzəliş et</h1>
        <form onSubmit={onSubmit}>
            <p className='text-lg mt-6 font-semibold'>Satış / Kirayə</p>
            <div className='flex'>
            ...
            <p className='text-lg mt-6 font-semibold'>Elanın adı</p>
            <input type="text" id='name' value={name} onChange={onChange} placeholder='Name' maxLength='32' minLength='10' required className='w-full px-4 py-2 text-lg text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 mb-6 ' />
            <div className='flex space-x-6 mb-6'>
                <div>
                    <p className='text-lg font-semibold'>Otaq sayı</p>
                ...
                <div>
                    <p className='text-lg font-semibold'>Sahə {' '}(m<sup>2</sup>)</p>
            ...
            <p className='text-lg mt-6 font-semibold'>Qarajlı</p>
            <div className='flex'>
            ...
            <p className='text-lg mt-6 font-semibold'>Mebelli</p>
            <div className='flex'>
            ...
            <p className='text-lg mt-6 font-semibold'>Ünvan</p>
            <textarea type="text" id='address' value={address} onChange={onChange} placeholder='Address' required maxLength="90"  className='w-full px-4 py-2 text-lg text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 mb-6 ' />
         
            <p className='text-lg font-semibold'>Məlumat</p>
            <textarea type="text" id='description' value={description} onChange={onChange} placeholder='Description' required className='w-full px-4 py-2 text-lg text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 mb-6 ' />
            
            <div className='flex items-center mb-6'>
                <div>
                <p className='text-lg font-semibold'>Qiymət</p>
                <div className='flex w-full justify-center items-center space-x-6'>
                    ...
                    {type === 'rent' && (
                    <div className=''>
                        <p className='text-md w-full whitespace-nowrap '>AZN / Aylıq</p>
                    </div>
                )}
                </div>
                </div>
            ...
            <div className='mb-6'>
                <p className='text-lg font-semibold'>Şəkillər</p>
                <p className='text-gray-600'>İlk şəkil əsas olacaq (ən çox 6 şəkil)</p>
            ...
            <button type='submit' className='mb-6 w-full px-7 py-3 bg-blue-600 text-white font-medium text-sm uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out'>Düzəliş et</button>
        </form>
    </main>
  )
}
