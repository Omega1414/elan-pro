...
export default function SignUp() {
  ...
  return (
    <section className='bg-white dark:bg-gray-900'>
      <h1 className='text-3xl text-center pt-6 font-bold text-black dark:text-gray-300'>Qeydiyyat</h1>
      <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          <form onSubmit={onSubmit}>
            <input className='mb-6 w-full px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out' type="text" id="name" value={name} onChange={onChange} placeholder="Ad" />
            ...
            <input className='mb-6 w-full px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out' type="text" id="phone" value={phone} onChange={onChange} placeholder="Nömrə" />
        ...
        <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
          <p className='mb-6 text-black dark:text-gray-300'>Hesabın var? <Link to='/sign-in' className='text-red-600 dark:text-yellow-400 hover:text-red-700 transition duration-200 ease-in-out ml-1'>Daxil ol</Link></p>
        ...
        <button type="submit" className='w-full bg-blue-600 text-white px-7 py-3 text-sm font-medium uppercase rounded shadow-md hover:bg-blue-700 transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-800'>Qeydiyyatdan keç</button>
