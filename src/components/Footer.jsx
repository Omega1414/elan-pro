...
export const Footer = () => {
  ...
  return (
   <div className="justify-center flex w-full  bg-gray-300 dark:bg-neutral-900">
 <footer className=" text-center text-white ">
  <div className="container px-6 pt-6">
    <div className="mb-6 flex justify-center">
      <a
        href="#!"
        type="button"
        className="m-1 h-9 w-9 rounded-full  border-2 border-black dark:border-white uppercase leading-normal text-black dark:text-white transition duration-150 ease-in-out hover:bg-blue-700 hover:bg-opacity-8 focus:outline-none focus:ring-0"
        data-te-ripple-init
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-4">
      <div className="mb-6">
        <h5 className="mb-2.5 font-bold uppercase text-black dark:text-white">Keçidlər</h5>

        <ul className="mb-0 list-none">
          <li>
            <a href="#!" className="text-black dark:text-white">Keçid 1</a>
          </li>
          <li>
            <a href="#!" className="text-black dark:text-white">Keçid 2</a>
          </li>
          <li>
            <a href="#!" className="text-black dark:text-white">Keçid 3</a>
          </li>
          <li>
            <a href="#!" className="text-black dark:text-white">Keçid 4</a>
          </li>
        </ul>
      </div>
  ...
  <div
    ...
    <a className="text-black dark:text-white" href="https://tailwind-elements.com/"
      >Vasif Babazadə</a
    >
  </div>
</footer>
